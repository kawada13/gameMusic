...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('recruitments')->insert([
            ...
            'content' =>'■希望予算<br>予算は大体5,000~10,000くらいで考えています。<br>■雰囲気<br>なるべく聞いてて懐かしさを感じさせるような感じがいいです。<br><br>■一言<br>メッセージで具体的な内容がやりとりできたらなと思います。よろしくお願いいたします！',
            'created_at' => date("Y-m-d H:i:s")
        ]);
        ...
        DB::table('recruitments')->insert([
            ...
            'content' => '爽快なオープニング曲が欲しいです。<br><br>RPGゲームのオープニング曲を考えています。<br>長めの2:30くらいがいいです。<br>予算は1,000~5,000くらいで考えています。<br><br>もし出来れば一度メッセージのやりとりを通して、より具体的に相談できたらなとおもいます。',
            'created_at' => date("Y-m-d H:i:s")
        ]);
        DB::table('recruitments')->insert([
            'user_id' => 13,
        ...
        DB::table('recruitments')->insert([
            'user_id' => 13,
            'title' => 'ゲームオーバー時のBGM',
            'content' => '■特徴<br>弦楽器を使った、悲しくて重い感じでお願いしたいです。<br><br>■予算<br>5,000~で考えています。<br><br>■一言<br>気になる点がございましたら、メッセージをいただけたらと思います。よろしくお願いいたします。',
            'created_at' => date("Y-m-d H:i:s")
        ]);
    }
}
